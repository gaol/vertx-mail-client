...
public class DKIMSignOptions {
  ...
  private PubSecKeyOptions pubSecKeyOptions;
  ...
  private boolean signatureTimestmap;
  ...
  /**
   * Gets the PubSecKeyOptions with private key specified.
   *
   * @return the PubSecKeyOptions
   */
  public PubSecKeyOptions getPubSecKeyOptions() {
    return pubSecKeyOptions;
  }

  /**
   * Sets the PubSecKeyOptions used to sign the email.
   *
   * @param pubSecKeyOptions the PubSecKeyOptions
   * @return a reference to this, so the API can be used fluently
   */
  public DKIMSignOptions setPubSecKeyOptions(PubSecKeyOptions pubSecKeyOptions) {
   ...
   */
  public boolean isSignatureTimestmap() {
    return signatureTimestmap;
  }

  /**
   * Sets to enable or disable signature sign timestmap. Default is disabled.
   *
   * @param signatureTimestmap if enable signature sign timestamp or not
   * @return a reference to this, so the API can be used fluently
   */
  public DKIMSignOptions setSignatureTimestmap(boolean signatureTimestmap) {
    this.signatureTimestmap = signatureTimestmap;
    return this;
  }
  ...
  private List<Object> getList() {
    return Arrays.asList(pubSecKeyOptions, signAlgo, signedHeaders, sdid, selector, headerCanonic, bodyCanonic
    , auid, bodyLimit, signatureTimestmap, expireTime, copiedHeaders);
  }
