...
+++
|[[expireTime]]`@expireTime`|`Number (int)`|+++
...
+++
|[[signatureTimestmap]]`@signatureTimestmap`|`Boolean`|+++
...
|[[dkimOptions]]`@dkimOptions`|`Array of link:dataobjects.html#DKIMSignOptions[DKIMSignOptions]`|+++
